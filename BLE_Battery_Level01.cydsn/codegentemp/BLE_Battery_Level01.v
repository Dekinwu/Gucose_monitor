...
`else
`define CY_BLK_DIR "d:\Program Files (x86)\Cypress\PSoC Creator\3.1\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\Bus_Connect_v2_0"
`include "d:\Program Files (x86)\Cypress\PSoC Creator\3.1\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\Bus_Connect_v2_0\Bus_Connect_v2_0.v"
`endif
...
module ADC_SAR_SEQ_P4_v2_0_0 (
	...
	cy_clock_v1_0
		#(.id("78e5ded9-caaf-43f8-b0dd-127e5b5ff36e/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
// OpAmp_P4_v1_10(Compensation=3, DeepSleepSupport=false, Mode=0, OutputCurrent=1, Power=2, CY_COMPONENT_NAME=OpAmp_P4_v1_10, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opamp, CY_INSTANCE_SHORT_NAME=Opamp, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.1, INSTANCE_NAME=Opamp, )
...
// PWM_v3_10(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=false, Compare2_8=true, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=127, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=false, Period=255, PWMMode=1, PWMModeCenterAligned=0, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=false, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=false, TermVisibility_pwm1=true, TermVisibility_pwm2=true, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=true, UseControl=true, UseInterrupt=false, UseStatus=false, VerilogSectionReplacementString=sP8, CY_COMPONENT_NAME=PWM_v3_10, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_NIR1, CY_INSTANCE_SHORT_NAME=PWM_NIR1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.1, INSTANCE_NAME=PWM_NIR1, )
module PWM_v3_10_5 (
    pwm2,
    tc,
    clock,
...
module top ;
	...
	wire [0:0] tmpOE__GA_SENSORP_net;
	wire [0:0] tmpFB_0__GA_SENSORP_net;
	wire [0:0] tmpIO_0__GA_SENSORP_net;
	wire [0:0] tmpINTERRUPT_0__GA_SENSORP_net;
	electrical [0:0] tmpSIOVREF__GA_SENSORP_net;

	cy_psoc3_pins_v1_10
		#(.id("37e47beb-bab6-49fe-908a-9d759ad8b8c5"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		GA_SENSORP
		 (.oe(tmpOE__GA_SENSORP_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GA_SENSORP_net[0:0]}),
		  .analog({Net_38}),
		  .io({tmpIO_0__GA_SENSORP_net[0:0]}),
		  .siovref(tmpSIOVREF__GA_SENSORP_net),
		  .interrupt({tmpINTERRUPT_0__GA_SENSORP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__GA_SENSORP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ADC_SAR_SEQ_P4_v2_0_0 ADC_SAR (
        .Vref(Net_1233),
        .sdone(Net_1234),
        .eoc(Net_1235),
        .aclk(1'b0),
	...
	wire [0:0] tmpOE__GA_SENSORN_net;
	wire [0:0] tmpFB_0__GA_SENSORN_net;
	wire [0:0] tmpIO_0__GA_SENSORN_net;
	wire [0:0] tmpINTERRUPT_0__GA_SENSORN_net;
	electrical [0:0] tmpSIOVREF__GA_SENSORN_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("05a9c8de-3ba2-4909-8250-95fdc61c0bf4"),
		  ...
		  .input_buffer_sel(2'b00))
		GA_SENSORN
		 (.oe(tmpOE__GA_SENSORN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GA_SENSORN_net[0:0]}),
		  .analog({Net_18}),
		  .io({tmpIO_0__GA_SENSORN_net[0:0]}),
		  .siovref(tmpSIOVREF__GA_SENSORN_net),
		  .interrupt({tmpINTERRUPT_0__GA_SENSORN_net[0:0]}),
		  .annotation({Net_46}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__GA_SENSORN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__IR_DRIVE_net;
	wire [0:0] tmpFB_0__IR_DRIVE_net;
	wire [0:0] tmpIO_0__IR_DRIVE_net;
	wire [0:0] tmpINTERRUPT_0__IR_DRIVE_net;
	electrical [0:0] tmpSIOVREF__IR_DRIVE_net;

	cy_psoc3_pins_v1_10
		#(.id("e7fc308e-4d30-47c0-94c6-d7292761c5c6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		IR_DRIVE
		 (.oe(tmpOE__IR_DRIVE_net),
		  .y({Net_3730}),
		  .fb({tmpFB_0__IR_DRIVE_net[0:0]}),
		  .io({tmpIO_0__IR_DRIVE_net[0:0]}),
		  .siovref(tmpSIOVREF__IR_DRIVE_net),
		  .interrupt({tmpINTERRUPT_0__IR_DRIVE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__IR_DRIVE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__NIR_DRIVE1_net;
	wire [0:0] tmpFB_0__NIR_DRIVE1_net;
	wire [0:0] tmpIO_0__NIR_DRIVE1_net;
	wire [0:0] tmpINTERRUPT_0__NIR_DRIVE1_net;
	electrical [0:0] tmpSIOVREF__NIR_DRIVE1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		NIR_DRIVE1
		 (.oe(tmpOE__NIR_DRIVE1_net),
		  .y({Net_4591}),
		  .fb({tmpFB_0__NIR_DRIVE1_net[0:0]}),
		  .io({tmpIO_0__NIR_DRIVE1_net[0:0]}),
		  .siovref(tmpSIOVREF__NIR_DRIVE1_net),
		  .interrupt({tmpINTERRUPT_0__NIR_DRIVE1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__NIR_DRIVE1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("9cc55221-8991-4fab-ad7e-f5dec59b544e"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    PWM_v3_10_3 PWM_IR_AND_RED (
        ...
        .ph1(Net_1259),
        .ph2(Net_1260));
    defparam PWM_IR_AND_RED.Resolution = 8;

	wire [0:0] tmpOE__NIR_DRIVE2_net;
	wire [0:0] tmpFB_0__NIR_DRIVE2_net;
	wire [0:0] tmpIO_0__NIR_DRIVE2_net;
	wire [0:0] tmpINTERRUPT_0__NIR_DRIVE2_net;
	electrical [0:0] tmpSIOVREF__NIR_DRIVE2_net;

	cy_psoc3_pins_v1_10
		#(.id("0897085d-f0f9-4804-a018-2c9e6a905e8b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		NIR_DRIVE2
		 (.oe(tmpOE__NIR_DRIVE2_net),
		  .y({Net_4592}),
		  .fb({tmpFB_0__NIR_DRIVE2_net[0:0]}),
		  .io({tmpIO_0__NIR_DRIVE2_net[0:0]}),
		  .siovref(tmpSIOVREF__NIR_DRIVE2_net),
		  .interrupt({tmpINTERRUPT_0__NIR_DRIVE2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__NIR_DRIVE2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__GREEN_DRIVE_net;
	wire [0:0] tmpFB_0__GREEN_DRIVE_net;
	wire [0:0] tmpIO_0__GREEN_DRIVE_net;
	wire [0:0] tmpINTERRUPT_0__GREEN_DRIVE_net;
	electrical [0:0] tmpSIOVREF__GREEN_DRIVE_net;

	cy_psoc3_pins_v1_10
		#(.id("16abb905-1204-48d2-af25-65efe93f4a38"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		GREEN_DRIVE
		 (.oe(tmpOE__GREEN_DRIVE_net),
		  .y({Net_120}),
		  .fb({tmpFB_0__GREEN_DRIVE_net[0:0]}),
		  .io({tmpIO_0__GREEN_DRIVE_net[0:0]}),
		  .siovref(tmpSIOVREF__GREEN_DRIVE_net),
		  .interrupt({tmpINTERRUPT_0__GREEN_DRIVE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__GREEN_DRIVE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__GA_SENSOR_OUT_net;
	wire [0:0] tmpFB_0__GA_SENSOR_OUT_net;
	wire [0:0] tmpIO_0__GA_SENSOR_OUT_net;
	wire [0:0] tmpINTERRUPT_0__GA_SENSOR_OUT_net;
	electrical [0:0] tmpSIOVREF__GA_SENSOR_OUT_net;

	cy_psoc3_pins_v1_10
		#(.id("8170ae3f-60bb-4483-8847-c84fe0b864d1"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		GA_SENSOR_OUT
		 (.oe(tmpOE__GA_SENSOR_OUT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GA_SENSOR_OUT_net[0:0]}),
		  .analog({Net_45}),
		  .io({tmpIO_0__GA_SENSOR_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__GA_SENSOR_OUT_net),
		  .interrupt({tmpINTERRUPT_0__GA_SENSOR_OUT_net[0:0]}),
		  .annotation({Net_6632}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__GA_SENSOR_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    cy_annotation_universal_v1_0 Rf (
        .connect({
            Net_46,
            Net_6632
        })
    );
    defparam Rf.comp_name = "Resistor_v1_0";
    defparam Rf.port_names = "T1, T2";
    defparam Rf.width = 2;
	...
	wire [0:0] tmpOE__RED_DRIVE_net;
	wire [0:0] tmpFB_0__RED_DRIVE_net;
	wire [0:0] tmpIO_0__RED_DRIVE_net;
	wire [0:0] tmpINTERRUPT_0__RED_DRIVE_net;
	electrical [0:0] tmpSIOVREF__RED_DRIVE_net;

	cy_psoc3_pins_v1_10
		#(.id("1a67b0da-8eca-458c-936c-f70ec64dda39"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RED_DRIVE
		 (.oe(tmpOE__RED_DRIVE_net),
		  .y({Net_2654}),
		  .fb({tmpFB_0__RED_DRIVE_net[0:0]}),
		  .io({tmpIO_0__RED_DRIVE_net[0:0]}),
		  .siovref(tmpSIOVREF__RED_DRIVE_net),
		  .interrupt({tmpINTERRUPT_0__RED_DRIVE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RED_DRIVE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    PWM_v3_10_5 PWM_NIR1 (
        .reset(1'b0),
        .clock(Net_1214),
        .tc(Net_1262),
        .pwm1(Net_4591),
        ...
        .ph1(Net_1270),
        .ph2(Net_1271));
    defparam PWM_NIR1.Resolution = 8;
