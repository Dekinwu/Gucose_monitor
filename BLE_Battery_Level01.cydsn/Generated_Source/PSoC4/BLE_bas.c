...
const CYBLE_BASS_T cyBle_bass[0x02u] = {
    {
        0x000Fu, /* Handle of the BAS service */ 
        0x0011u, /* Handle of the Battery Level characteristic */ 
        0x0012u, /* Handle of the Characteristic Presentation Format descriptor */ 
